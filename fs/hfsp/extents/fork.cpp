...
ForkData::ForkData(uint32_t fileid, uint64_t blocksize) //: __fileId(fileid), __blockSize(blocksize), __initialSize(0), __extendedSize(0), __type(0), __etree(NULL), __fork(), __extents()
{
}


ForkData::ForkData(uint32_t fileid, ExtentsTree* etree) //: __fileId(fileid), __blockSize(0), __initialSize(0), __extendedSize(0), __type(0), __etree(etree), __fork(), __extents()
{
  if (etree != NULL)
